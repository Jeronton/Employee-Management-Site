...
<head>
    ...
    <title><?= $title ?></title>
    <script src="tinymce_5.2.1/js/tinymce.min.js"></script>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="collapse navbar-collapse d-flex d-flex justify-content-end">
                <?php if(isset($_SESSION['logged']) && $_SESSION['logged']): ?>
                    ...
                    <img src="<?php if(empty($_SESSION['profilepicture'])){echo 'images/BlankProfile.jpg';}else{echo $_SESSION['profilepicture'];} ?>" alt="Profile Image" id="headerprofileimage">
                <?php else: ?>
